...
function StatPreviewCard({
  ...
  return (
    <Link
      to={`/statistiche/stagione/${seasonId}/${statKey}`}
...
/**
 * Statistiche di una singola stagione (selezionata dall'elenco stagioni della
 * sezione Statistiche). Le viste Generali e Personali sono le stesse di prima,
 * ma sempre relative alla stagione scelta.
 */
        ...
        <>
          ...
          {stats.length > 0 && (
            <div className="mt-8 flex justify-center">
              <Link
                to={`/statistiche/stagione/${id}/elenco`}
